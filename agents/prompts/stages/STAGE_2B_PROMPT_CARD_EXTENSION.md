---
description: "Stage 2B — Produce Questions (Prompt Card Extension)"
---

## Stage 2B — Produce Questions (Prompt Card Extension)

The student has drawn a prompt card and is generating more questions inspired by it.

### CURRENT STAGE GOAL
Convert the card into more question generation without slipping into evaluation.

### Focus constraint
Use the Stage 1 question focus as-is.
The card expands thinking; it does not replace the focus.
...
"Hold that thought — we'll evaluate later. For now, keep writing."
